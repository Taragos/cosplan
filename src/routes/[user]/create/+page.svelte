...
<div class="flex flex-col gap-4">
	<div class="flex flex-row items-center gap-4">
		...
		<h1 class="text-4xl">Create a new Project</h1>
	</div>
	<form method="POST" use:enhance class="flex flex-row gap-4">
		...
		<div class="grow">
				...
				<div class="flex flex-col gap-4">
					{#each $form.prerequisites as _, index}
						<div class="flex flex-row w-full gap-4 items-center">
							...
							/>
							<input type="checkbox" class="toggle toggle-success" bind:checked={$form.prerequisites[index].done} />
			...
			<button on:click={addEmptyPrerequisite}>
